...
-- ----------------------------
INSERT INTO `power_analyse_day_avg` VALUES (4, 1641312000, '2,274.15', '783.96', '731.74', '758.45', '751.96', '260.89', '240.89', '250.19', '0.95', '0.95', '0.95', '0.95', '2,975.41', '2,974.57', '2,974.43', '198.29', '225.14', '224.92', '224.98', '390.31', '389.86', '390.15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
-- ----------------------------
INSERT INTO `power_analyse_day_max` VALUES (2, 1641312000, '2998.96', '1049.14', '985.65', '1008.92', '998.58', '349.45', '328.85', '313.39', '0.9998', '0.9996', '0.9999', '0.9998', '2999.62', '2999.49', '2999.89', '199.97', '229.93', '229.91', '229.96', '399.98', '399.94', '399.91', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1641324900, 1641362700, 1641315600, 1641350100, 1641327000, 1641315600, 1641395100, 1641346200, 1641331500, 1, NULL, NULL, 1641374100, NULL, 1641361800, NULL, 1641321600, 1641324900, 1641367500, 1641331500, NULL, NULL, NULL, NULL, NULL, NULL, 1641353700, 1641347700, NULL, NULL, 1641332100, 1641389100, NULL, NULL, 1641337800, 1641358500, 1641327900);
...
-- ----------------------------
INSERT INTO `power_analyse_day_min` VALUES (1, 1641312000, '1506.90', '507.82', '461.22', '551.49', '500.19', '172.02', '148.58', '170.89', '0.9002', '0.9001', '0.9000', '0.9002', '2950.26', '2950.00', '2950.27', '196.67', '220.05', '220.00', '220.03', '380.03', '380.01', '380.08', '111', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1641380400, 1641396600, 1641393600, 1641348300, 1641375300, 1641385800, 1641354300, 1641366300, 1641369300, 1, NULL, NULL, 1641320100, NULL, 1641329700, NULL, 1641321000, 1641380400, 1641314100, 1641390300, NULL, NULL, NULL, NULL, NULL, NULL, 1641360900, 1641387900, NULL, NULL, 1641329700, 1641348000, NULL, NULL, 1641384000, 1641396900, 1641395100);
...
CREATE TABLE `power_analyse_year_avg`  (
  ...
  `dataTime` int(11) NULL DEFAULT NULL,
  `deviceId` int(11) NOT NULL,
  `iUnbalance` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ia` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `iaPHD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ib` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ibPHD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `icPHD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `totalLoad` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `totalPowerFactor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `totalReactivePower` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uUabDeviation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uUbcDeviation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uUcaDeviation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uUnbalance` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ua` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uaDeviation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uaPHD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `uab` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ub` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ubDeviation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ubPHD` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `power_distribution_day`  (
  ...
  `totalLoad` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '负荷',
