...
public class PowerRealtimeController {
    ...
    public List<PowerRealtime> findPowerRealtimeByDeviceIdAndDataTimeBetween(@RequestBody PowerRealtime powerRealtime) {
        System.out.println("test "+powerRealtime.getDataTime());
        if (powerRealtime.getId() == 0) {
            powerRealtime.setId(1);
        }
/*        //使用id暂存天数
        System.out.println("did  "+powerRealtime.getId()+"   "+powerRealtime.getTotalLoad()+"  "+powerRealtime.getDataTime());
        Integer start = powerRealtime.getDataTime();
        Integer end =  powerRealtime.getDataTime() + 86400 * powerRealtime.getId();
...
//        return powerRealtimeService.findPowerRealtimeByDeviceIdAndDataTimeBetween(powerRealtime.getDeviceId(), 1657957200, 1657957200 + 86400 * powerRealtime.getId());
    }
...
//        return powerRealtimeService.findPowerRealtimeByDataTimeForTable(powerRealtime.getDeviceId(), 1657957200, 1657957200 + 86400 * powerRealtime.getId() - 1);
...
//        return powerRealtimeService.findPowerDistributionHourByDeviceIdAndDataTimeBetween(powerDistributionHour.getDeviceId(), powerDistributionHour.getDataTime(), powerDistributionHour.getDataTime() + 86400 * powerDistributionHour.getId() - 1);
        return powerRealtimeService.findPowerDistributionHourByDeviceIdAndDataTimeBetween(powerDistributionHour.getDeviceId(), 1657957200, 1657957200 + 86400 * powerDistributionHour.getId() - 1);
    }
...
//        return powerRealtimeService.findPowerDistributionHourByDataTimeForAdd(powerDistributionHour.getDeviceId(), powerDistributionHour.getDataTime(), powerDistributionHour.getDataTime() + 86400 * powerDistributionHour.getId() - 1);
        return powerRealtimeService.findPowerDistributionHourByDataTimeForAdd(powerDistributionHour.getDeviceId(), 1657957200, 1657957200 + 86400 * powerDistributionHour.getId() - 1);
...
//        return powerRealtimeService.findPowerDistributionHourByDataTimeForTable(powerDistributionHour.getDeviceId(), powerDistributionHour.getDataTime(), powerDistributionHour.getDataTime() + 86400 * powerDistributionHour.getId() - 1);
        return powerRealtimeService.findPowerDistributionHourByDataTimeForTable(powerDistributionHour.getDeviceId(), 1657957200, 1657957200 + 86400 * powerDistributionHour.getId() - 1);
    }
...
//        return powerRealtimeService.findPowerQualityRealtimeByDeviceIdAndDataTimeBetween(powerQualityRealtime.getDeviceId(), powerQualityRealtime.getDataTime(), powerQualityRealtime.getDataTime() + 86400 * powerQualityRealtime.getId());
        return powerRealtimeService.findPowerQualityRealtimeByDeviceIdAndDataTimeBetween(powerQualityRealtime.getDeviceId(), 1657957200, 1657957200 + 86400 * powerQualityRealtime.getId());
...
//        return powerRealtimeService.findPowerQualityRealtimeByDataTimeForTable(powerQualityRealtime.getDeviceId(), powerQualityRealtime.getDataTime(), powerQualityRealtime.getDataTime() + 86400 * powerQualityRealtime.getId() - 1);
        return powerRealtimeService.findPowerQualityRealtimeByDataTimeForTable(powerQualityRealtime.getDeviceId(), 1657957200, 1657957200 + 86400 * powerQualityRealtime.getId() - 1);
...
//        return powerRealtimeService.findPowerDistributionDayByDeviceIdAndDataTimeBetween(powerDistributionDay.getDeviceId(), powerDistributionDay.getDataTime(), powerDistributionDay.getDataTime() + 86400 * powerDistributionDay.getId());
        return powerRealtimeService.findPowerDistributionDayByDeviceIdAndDataTimeBetween(powerDistributionDay.getDeviceId(), 1657957200, 1657957200 + 86400 * powerDistributionDay.getId());
