        ...
        if (objects == null) {
            ...
            for (Object[] o : objects
                ...
                if (o[4] == null) { //superDeviceID为null
                    if (!deviceName.contains(String.valueOf(o[0]))) {
                        deviceName.add(String.valueOf(o[0]));
    ...
    public ArrayList recursionTree(List<Object[]> objects, Integer topId, Integer type) {
        ...
        for (Object[] o : objects) {
            ...
            if (o[5] != null && o[4] == topId) {
                if (deviceName.size() != 0 && deviceName.contains((String) o[0])) {
                    continue;
                }
